import { ChannelStructure, Snowflake, ThreadMemberStructure } from "@lunajs/core";
import { z } from "zod";
...
export const ChannelPinsUpdateFields = z.object({
	 ...
	 */
	last_pin_timestamp: z.string().optional(),
});
 ...
 */
export const ThreadMemberUpdateExtraFields = z.object({
	/**
	 * ID of the guild
	 */
	guild_id: Snowflake,
...
export type ThreadMemberUpdateExtraFieldsInfer = z.infer<typeof ThreadMemberUpdateExtraFields>;
